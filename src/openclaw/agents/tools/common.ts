/**
 * Local type stubs for @mariozechner/pi-agent-core.
 * Avoids pulling in the external package — these are the only shapes used.
 */
...
export type AgentTool<TParams = any, TDetails = unknown> = {
  label: string;
  name: string;
  description: string;
